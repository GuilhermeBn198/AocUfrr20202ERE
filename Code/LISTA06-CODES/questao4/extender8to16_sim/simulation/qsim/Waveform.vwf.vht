...
-- *****************************************************************************
-- Generated on "03/22/2021 20:31:03"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          extender8to16
-- 
...
ENTITY extender8to16_vhd_vec_tst IS
END extender8to16_vhd_vec_tst;
ARCHITECTURE extender8to16_arch OF extender8to16_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL in_port : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL out_port : STD_LOGIC_VECTOR(15 DOWNTO 0);
COMPONENT extender8to16
	PORT (
